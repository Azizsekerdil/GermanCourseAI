...
LM Studio kapalıysa uygulama çalışmaya devam eder; yalnız AI düğmeleri erişilemez yanıtı gösterir. Prompt ve AI yanıt metinleri veritabanına yazılmaz. Token defteri yalnız model, görev, token sayıları, süre ve başarı durumunu saklar. NVIDIA NIM varsayılan olarak kapalıdır; anahtarlar ayar dosyasına yazılmaz.
...
gca/                    Bağımsız Python paketi
  ...
  ai_client.py          LM Studio istemcisi
