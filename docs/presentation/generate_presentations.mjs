...
const configs = [
  {
    ...
    platformLineTr: "Windows 10/11 (x64) + macOS (Apple Silicon) — İndirme: github.com/Azizsekerdil/GermanCourseAI/releases (v1.2.1) · (özel repo)",
    ...
    releaseUrl: "https://github.com/Azizsekerdil/GermanCourseAI/releases/tag/v1.2.1",
  },
  {
