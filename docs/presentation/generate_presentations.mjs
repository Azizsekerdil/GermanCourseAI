...
const configs = [
  {
    ...
    metricWords: "160", metricTests: "86 / 86",
    ...
    platformLineTr: "Windows 10/11 (x64) + macOS (Apple Silicon) — İndirme: github.com/Azizsekerdil/GermanCourseAI/releases (v1.2.0) · (özel repo)",
    platformLineEn: "Windows 10/11 (x64) & macOS (Apple Silicon) — Download: GitHub Releases (v1.2.0)",
    ...
    releaseUrl: "https://github.com/Azizsekerdil/GermanCourseAI/releases/tag/v1.2.0",
  },
  {
    ...
    closeSub: "Bağımsız Windows uygulaması, belgeler, testler ve sunum tek pakette.",
    metricWords: "162", metricTests: "70 / 70",
    metricWordsLabel: "benzersiz A1 kelime\nunique A1 words\nmots A1 uniques",
    ...
    platformCaption: "Windows x64 · macOS arm64",
    platformLineTr: "Windows 10/11 (x64) + macOS (Apple Silicon) — İndirme: github.com/Azizsekerdil/FrenchCourseAI/releases (v1.1.2) · (özel repo)",
    platformLineEn: "Windows 10/11 (x64) & macOS (Apple Silicon) — Download: GitHub Releases (v1.1.2)",
    macNote: "macOS paketi Apple Silicon (arm64) içindir ve notarize edilmemiştir; ilk açılışta sağ tık → Aç. / Not notarized; first launch: right-click → Open.",
    releaseUrl: "https://github.com/Azizsekerdil/FrenchCourseAI/releases/tag/v1.1.2",
  },
];
