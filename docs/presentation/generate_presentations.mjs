...
const configs = [
  {
    ...
    flowHeads: ["Öğrenci bağlamı", "LM Studio", "Güvenli kayıt"],
    flowBodies: ["Seviye, hedef ve etkin çalışma uygulama içinde derlenir.", "İstek yalnızca yerel uç noktaya gider; bağlantı yoksa akış güvenle kapanır.", "Yalnızca süre, token sayısı ve durum tutulur; konuşma metni tutulmaz."],
    ...
    platformLineTr: "Windows 10/11 (x64) + macOS (Apple Silicon) — İndirme: github.com/Azizsekerdil/GermanCourseAI/releases (v1.0.0) · (özel repo)",
    platformLineEn: "Windows 10/11 (x64) & macOS (Apple Silicon) — Download: GitHub Releases (v1.0.0)",
    ...
    releaseUrl: "https://github.com/Azizsekerdil/GermanCourseAI/releases/tag/v1.0.0",
  },
  {
    ...
    platformCaption: "Windows x64 · macOS arm64",
    platformLineTr: "Windows 10/11 (x64) + macOS (Apple Silicon) — İndirme: github.com/Azizsekerdil/FrenchCourseAI/releases (v1.0.0) · (özel repo)",
    platformLineEn: "Windows 10/11 (x64) & macOS (Apple Silicon) — Download: GitHub Releases (v1.0.0)",
    macNote: "macOS paketi Apple Silicon (arm64) içindir ve notarize edilmemiştir; ilk açılışta sağ tık → Aç. / Not notarized; first launch: right-click → Open.",
    releaseUrl: "https://github.com/Azizsekerdil/FrenchCourseAI/releases/tag/v1.0.0",
  },
];
